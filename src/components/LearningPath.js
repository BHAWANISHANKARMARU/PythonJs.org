    ...
    >
      ...
      <motion.div className={styles.cards}>
        <motion.div className={styles.card} variants={itemVariants}>
          <div className={styles.icon}><GraduationCap color="#64FFDA" size={48} /></div>
          <h3>Beginner</h3>
        ...
        <motion.div className={styles.card} variants={itemVariants}>
          <div className={styles.icon}><Rocket color="#64FFDA" size={48} /></div>
          <h3>Intermediate</h3>
        ...
        <motion.div className={styles.card} variants={itemVariants}>
          <div className={styles.icon}><Crown color="#64FFDA" size={48} /></div>
          <h3>Advanced</h3>
